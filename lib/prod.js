...
var Mask = TYPES.MASK; // export const Graphics = TYPES.GRAPHICS;

var Circle = TYPES.CIRCLE; // export const Curve = TYPES.CURVE;
...
var Star = TYPES.STAR; // export const Shape = TYPES.SHAPE;
...
var setFillStyle = function setFillStyle(inst, _ref14) {
  var fillColor = _ref14.fillColor,
      alpha = _ref14.alpha;
  return console.log(',/???', fillColor) || inst.setFillStyle(fillColor, alpha);
};
...
var allowedProps$3 = ['texture', 'frame', 'x', 'y', 'z', 'width', 'height', 'origin', 'alpha', 'angle', 'scale', 'tint', 'visible', 'interactive', 'mask'];
...
var allowedProps$8 = ['x', 'y', 'z', 'radius', 'fillColor', 'alpha', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$9 = ['x', 'y', 'z', 'width', 'height', 'fillColor', 'alpha', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$a = ['x', 'y', 'z', 'x1', 'y1', 'x2', 'y2', 'x3', 'y3', 'fillColor', 'alpha', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$b = ['x', 'y', 'z', 'width', 'height', 'fillColor', 'alpha', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$c = ['x', 'y', 'z', 'points', 'fillColor', 'alpha', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$d = ['x', 'y', 'z', 'points', 'innerRadius', 'outerRadius', 'fillColor', 'alpha', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$e = ['x', 'y', 'width', 'height', 'interactive', 'origin'];
...
var allowedProps$f = ['texture', 'frame', 'pause', 'start'];
...
var allowedProps$g = ['play'];

var getInst = function getInst(el) {
  return el.instance;
};
...
var allowedProps$h = ['x', 'y', 'frame', 'data'];
...
var allowedProps$i = ['x', 'y', 'width', 'height', 'placeholder', 'value', 'readonly', 'style', 'tooltip'];
var eventMap$1 = {
  onInput: 'input',
  onChange: 'change',
  onDbClick: 'dblclick',
...
var allowedProps$j = ['play'];

var Mask$1 =
/*#__PURE__*/
function (_GameObject) {
  _inherits(Mask, _GameObject);
...
var PhaserRenderer = reactReconciler((_Reconciler = {
  ...
  createInstance: function createInstance(type, props, scope) {
    switch (type) {
      ...
      case TYPES.CIRCLE:
        return new Circle$1(props);

      case TYPES.ELLIPSE:
        return new Ellipse$1(props);

      case TYPES.TRIANGLE:
        return new Triangle$1(props);

      case TYPES.RECTANGLE:
        return new Rectangle$1(props);

      case TYPES.POLYGON:
        return new Polygon$1(props);

      case TYPES.STAR:
        return new Star$1(props);
