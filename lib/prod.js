...
var _GeomNodes;
var GeomNodes = (_GeomNodes = {}, _defineProperty(_GeomNodes, TYPES.RECTANGLE, function (scene, _ref) {
  var x = _ref.x,
      y = _ref.y,
      width = _ref.width,
      height = _ref.height,
  ...
  return shape;
}), _defineProperty(_GeomNodes, TYPES.ROUNDEDRECTANGLE, function (scene, _ref2) {
  var x = _ref2.x,
      y = _ref2.y,
      width = _ref2.width,
      height = _ref2.height,
  ...
  return shape;
}), _defineProperty(_GeomNodes, TYPES.TRIANGLE, function (scene, _ref3) {
  var x = _ref3.x,
      y = _ref3.y,
      x1 = _ref3.x1,
      y1 = _ref3.y1,
  ...
  return shape;
}), _defineProperty(_GeomNodes, TYPES.CIRCLE, function (scene, _ref4) {
  var x = _ref4.x,
      y = _ref4.y,
      radius = _ref4.radius,
  ...
  return shape;
}), _defineProperty(_GeomNodes, TYPES.ELLIPSE, function (scene, _ref5) {
  var x = _ref5.x,
      y = _ref5.y,
      width = _ref5.width,
      height = _ref5.height,
...
function (_TransparentGameObjec) {
  ...
  _createClass(Mask, [{
    ...
    key: "createMaskObject",
    value: function createMaskObject(scene, type, props) {
      if (GeomNodes[type]) {
