  ...
  module.exports = function $$$reconciler($$$hostConfig) {
      ...
      do {
        a: switch (a.tag) {
          ...
          default:
            ...
            f = '';
            e
              ? (f = ' (at ' + e.fileName.replace(zb, '') + ':' + e.lineNumber + ')')
              : c && (f = ' (created by ' + c + ')');
            c = '\n    in ' + (d || 'Unknown') + f;
        }
    ...
    function Fc(a, b) {
      ...
      if (null === c) {
        ...
        (d = a.updateQueue),
          ...
          null === d
            ? null === e
              ? ((d = a.updateQueue = Bc(a.memoizedState)), (e = c.updateQueue = Bc(c.memoizedState)))
              : (d = a.updateQueue = Cc(e))
            : null === e && (e = c.updateQueue = Cc(d));

      null === e || d === e
        ? Ec(d, b)
        : null === d.lastUpdate || null === e.lastUpdate
        ? (Ec(d, b), Ec(e, b))
        : (Ec(d, b), (e.lastUpdate = b));
    }
    ...
    function Jc(a, b, c, d, e) {
      ...
      for (var f = b.baseState, g = null, l = 0, h = b.firstUpdate, k = f; null !== h; ) {
        ...
        n < e
          ? (null === g && ((g = h), (f = k)), l < n && (l = n))
          : (Mc(n, h.suspenseConfig),
            (k = Ic(a, b, h, k, c, d)),
            null !== h.callback &&
              ((a.effectTag |= 32),
              (h.nextEffect = null),
          ...
          : ((k = Ic(a, b, h, k, c, d)),
            null !== h.callback &&
              ...
              null === b.lastCapturedEffect
                ...
                : ((b.lastCapturedEffect.nextEffect = h), (b.lastCapturedEffect = h))));
        h = h.next;
      }
    ...
    function Yc(a, b, c) {
      ...
      'object' === typeof f && null !== f
        ? (f = zc(f))
        : ((e = C(b) ? Eb : A.current), (d = b.contextTypes), (f = (d = null !== d && void 0 !== d) ? Fb(a, e) : Db));
      b = new b(c, f);
    ...
    function $c(a, b, c, d) {
      ...
      'function' === typeof b.getDerivedStateFromProps ||
        ...
        b !== e.state && Wc.enqueueReplaceState(e, e.state, null),
        (f = a.updateQueue),
        null !== f && (Jc(a, f, c, e, d), (e.state = a.memoizedState)));
    ...
    function dd(a) {
      ...
      function h(b, a, c, d) {
        if (null !== a && a.elementType === c.type)
          return (d = e(a, c.props)), (d.ref = bd(b, a, c)), (d.return = b), d;
      ...
      function k(b, a, c, d) {
        if (
          ...
          return (a = hd(c, b.mode, d)), (a.return = b), a;
        a = e(a, c.children || []);
        a.return = b;
        return a;
      }
          ...
          switch (d.$$typeof) {
            case ca:
              return (
                ...
                d.type === ea ? n(a, b, d.props.children, e, d.key) : h(a, b, d, e)
              );
      ...
      function Fa(e, g, h, l) {
        ...
        for (t = d(e, t); r < h.length; r++)
          (n = J(t, e, r, h[r], l)),
            null !== n &&
              (a && null !== n.alternate && t.delete(null === n.key ? r : n.key),
              (g = f(n, g, r)),
              null === w ? (k = n) : (w.sibling = n),
              (w = n));
          ...
          switch (f.$$typeof) {
            case ca:
              a: {
                ...
                f.type === ea
                  ? ((d = id(f.props.children, a.mode, h, f.key)), (d.return = a), (a = d))
                  : ((h = gd(f.type, f.key, f.props, null, a.mode, h)), (h.ref = bd(a, d, f)), (h.return = a), (a = h));
              }
    ...
    function Od() {
      if (null !== Ad) (L = Ad), (Ad = L.next), (K = yd), (yd = null !== K ? K.next : null);
      else {
    ...
    function Qd(a) {
      ...
      if (null !== d) {
        ...
        do {
          var n = h.expirationTime;
          n < wd
            ? (k || ((k = !0), (l = g), (e = f)), n > Bd && ((Bd = n), Nc(Bd)))
            : (Mc(n, h.suspenseConfig), (f = h.eagerReducer === a ? h.eagerState : a(f, h.action)));
          g = h;
          h = h.next;
        } while (null !== h && h !== d);
    ...
    function Rd(a, b, c, d) {
      ...
      null === Cd
        ? ((Cd = {
          ...
          (Cd.lastEffect = a.next = a))
        : ((b = Cd.lastEffect),
          null === b ? (Cd.lastEffect = a.next = a) : ((c = b.next), (b.next = a), (a.next = c), (Cd.lastEffect = a)));
      return a;
    }
    ...
    function le(a, b, c, d, e, f) {
      if (null === a) {
        ...
        if (
          ...
          return (b.tag = 15), (b.type = g), ne(a, b, g, d, e, f);
      ...
      g = a.child;
      if (e < f && ((e = g.memoizedProps), (c = c.compare), (c = null !== c ? c : oc), c(e, d) && a.ref === b.ref))
        return ke(a, b, f);
      b.effectTag |= 1;
      a = ed(g, d);
      a.ref = b.ref;
    ...
    function ne(a, b, c, d, e, f) {
      return null !== a && oc(a.memoizedProps, d) && a.ref === b.ref && ((yc = !1), e < f)
        ? ke(a, b, f)
        : oe(a, b, c, d, f);
    }
    ...
    function qe(a, b, c, d, e) {
      ...
      if (null === b.stateNode)
        ...
        l !== d || x !== h || B.current || Ac
          ? ('function' === typeof n && (Sc(b, c, n, d), (h = b.memoizedState)),
            (l = Ac || Xc(b, c, l, d, x, h, k))
              ? (D ||
        ...
        (g = b.stateNode),
          (l = b.memoizedProps),
          (g.props = b.type === b.elementType ? l : G(b.type, l)),
          (h = g.context),
          (k = c.contextType),
          'object' === typeof k && null !== k ? (k = zc(k)) : ((k = C(c) ? Eb : A.current), (k = Fb(b, k))),
          ...
          l !== d || h !== x || B.current || Ac
            ? ('function' === typeof n && (Sc(b, c, n, d), (x = b.memoizedState)),
              (n = Ac || Xc(b, c, l, d, h, x, k))
                ? (D ||
    ...
    function ke(a, b, c) {
      ...
      if (null !== b.child) {
        ...
        for (c.return = b; null !== a.sibling; )
          (a = a.sibling), (c = c.sibling = ed(a, a.pendingProps, a.expirationTime)), (c.return = b);
      ...
      ye = function(a, b, c, d) {
        for (var e = b.child; null !== e; ) {
          if (5 === e.tag) {
            ...
            Ga(a, f);
          } else if (6 === e.tag) (f = e.stateNode), c && d && (f = nb(f, e.memoizedProps, e)), Ga(a, f);
          else if (4 !== e.tag) {
            if (13 === e.tag && 0 !== (e.effectTag & 4) && (f = null !== e.memoizedState)) {
              ...
              if (
                null !== g &&
                (null !== g.child && ((g.child.return = g), ye(a, g, !0, f)), (f = g.sibling), null !== f)
              ) {
                f.return = e;
                e = f;
                continue;
      ...
      var Ce = function(a, b, c, d) {
        for (var e = b.child; null !== e; ) {
          if (5 === e.tag) {
            ...
            c && d && (f = mb(f, e.type, e.memoizedProps, e));
            jb(a, f);
          } else if (6 === e.tag) (f = e.stateNode), c && d && (f = nb(f, e.memoizedProps, e)), jb(a, f);
          else if (4 !== e.tag) {
            if (13 === e.tag && 0 !== (e.effectTag & 4) && (f = null !== e.memoizedState)) {
              var g = e.child;
              ...
              if (
                null !== g &&
                (null !== g.child && ((g.child.return = g), Ce(a, g, !0, f)), (f = g.sibling), null !== f)
              ) {
                f.return = e;
                e = f;
                continue;
    ...
    function Re(a, b, c) {
      for (var d = b; ; )
        if ((Ne(a, d, c), null === d.child || (Qa && 4 === d.tag))) {
          if (d === b) break;
    ...
    function Pe(a, b, c) {
      for (var d = b, e = !1, f, g; ; ) {
        ...
        if (5 === d.tag || 6 === d.tag) Re(a, d, c), g ? ab(f, d.stateNode) : $a(f, d.stateNode);
        else if (4 === d.tag) {
          if (null !== d.child) {
    ...
    function Vc(a, b) {
      ...
      if (null !== a) {
        ...
        (T & 4) === Q ||
          (98 !== c && 99 !== c) ||
          (null === Bf ? (Bf = new Map([[a, b]])) : ((c = Bf.get(a)), (void 0 === c || c > b) && Bf.set(a, b)));
      }
    }
    ...
    function Z(a) {
      if (0 !== a.lastExpiredTime)
        (a.callbackExpirationTime = 1073741823), (a.callbackPriority = 99), (a.callbackNode = jc(Hf.bind(null, a)));
      else {
        var b = Kf(a),
          c = a.callbackNode;
          ...
          if (null === V)
            switch (
              ...
              case of:
                ...
                1073741823 !== tf
                  ? (d = 10 * (1073741821 - tf) - E())
                  : 1073741823 === sf
                  ? (d = 0)
                  : ((d = 10 * (1073741821 - sf) - 5e3),
                    (e = E()),
                    (c = 10 * (1073741821 - c) - e),
                    (d = e - d),
                    0 > d && (d = 0),
              ...
              case pf:
                if (1073741823 !== sf && null !== uf) {
                  ...
                  0 >= d
                    ? (d = 0)
                    : ((e = g.busyDelayMs | 0),
                      (f = E() - (10 * (1073741821 - f) - (g.timeoutMs | 0 || 5e3))),
                      (d = f <= e ? 0 : e + d - f));
    ...
    function Hf(a) {
      var b = a.lastExpiredTime;
      b = 0 !== b ? b : 1073741823;
      if (a.finishedExpirationTime === b) Uf(a);
      else {
        if ((T & (R | S)) !== Q) throw p(Error(327));
        Of();
        (a === U && b === W) || Pf(a, b);
            ...
            if (null !== f && 'object' === typeof f && 'function' === typeof f.then) {
              ...
              do {
                ...
                if ((k = 13 === h.tag)) {
                  ...
                  if (null !== n) k = null !== n.dehydrated ? !0 : !1;
                  else {
                ...
                if (k) {
                  ...
                  var N = c.pingCache;
                  null === N
                    ? ((N = c.pingCache = new $e()), (f = new Set()), N.set(g, f))
                    : ((f = N.get(g)), void 0 === f && ((f = new Set()), N.set(g, f)));
                ...
                case 1:
                  ...
                  if (
                    ...
                    ('function' === typeof t.getDerivedStateFromError ||
                      (null !== M && 'function' === typeof M.componentDidCatch && (null === ef || !ef.has(M))))
                  ) {
                    h.effectTag |= 4096;
                    h.expirationTime = b;
                    var Kc = df(h, g, b);
        ...
        if (0 === (V.effectTag & 2048)) {
          a: {
            ...
            switch (b.tag) {
              ...
              case 5:
                ...
                d = od(nd.current);
                var f = b.type;
                if (null !== c && null != b.stateNode) Ae(c, b, f, e, d), c.ref !== b.ref && (b.effectTag |= 128);
                else if (e) {
                  c = od(H.current);
              ...
              case 6:
                if (c && null != b.stateNode) Be(c, b, c.memoizedProps, e);
                else {
                    ...
                    d ||
                      ...
                      null !== f &&
                        ...
                        null !== g
                          ...
                          : ((b.firstEffect = b.lastEffect = f), (f.nextEffect = null)),
                        (f.effectTag = 8))));
                if (d && !e && 0 !== (b.mode & 2))
                  if ((null === c && !0 !== b.memoizedProps.unstable_avoidThisFallback) || 0 !== (I.current & 1))
                    X === kf && (X = nf);
                  else {
                    if (X === kf || X === nf) X = of;
              ...
              case 19:
                ...
                if (null === g) {
                  if (f) De(e, !1);
                    ...
                    if (X !== kf || (null !== c && 0 !== (c.effectTag & 64)))
                            ...
                            (e = d),
                              ...
                              null === g
                                ? ((e.childExpirationTime = 0),
                                  ...
                                  (e.updateQueue = null),
                                  (e.dependencies = null))
                                : ((e.childExpirationTime = g.childExpirationTime),
                                  (e.expirationTime = g.expirationTime),
                                  (e.child = g.child),
                  ...
                  if (!f)
                    if (((c = td(g)), null !== c)) {
                      ...
                      E() > e.tailExpiration &&
                        1 < d &&
                        ((b.effectTag |= 64), (f = !0), De(e, !1), (b.expirationTime = b.childExpirationTime = d - 1));
                  e.isBackwards
                    ? ((g.sibling = b.child), (b.child = g))
                    : ((c = e.last), null !== c ? (c.sibling = g) : (b.child = g), (e.last = g));
                }
          ...
          if (1 === W || 1 !== c.childExpirationTime) {
            ...
            for (e = c.child; null !== e; )
              (f = e.expirationTime), (g = e.childExpirationTime), f > d && (d = f), g > d && (d = g), (e = e.sibling);
          ...
          null !== a &&
            ...
            null !== V.lastEffect &&
              (null !== a.lastEffect && (a.lastEffect.nextEffect = V.firstEffect), (a.lastEffect = V.lastEffect)),
            1 < V.effectTag &&
              (null !== a.lastEffect ? (a.lastEffect.nextEffect = V) : (a.firstEffect = V), (a.lastEffect = V)));
        } else {
          b = Ee(V);
        ...
        for (var c = a.return; null !== c; ) {
          if (3 === c.tag) {
            ...
            if (
              ...
              ('function' === typeof d.componentDidCatch && (null === ef || !ef.has(d)))
            ) {
              a = Fe(b, a);
              a = df(c, a, 1073741823);
              Fc(c, a);
    ...
    function $f(a, b, c) {
      ...
      null !== d && d.delete(b);
      U === a && W === c
        ? X === of || (X === nf && 1073741823 === sf && E() - Ye < xf)
          ? Pf(a, W)
          : (wf = !0)
        : Lf(a, c) &&
          ((b = a.lastPingedTime),
    ...
    cg = function(a, b, c) {
      ...
      if (null !== a) {
        ...
        if (a.memoizedProps !== e || B.current) yc = !0;
        else {
          if (d < c) {
            yc = !1;
      ...
      switch (b.tag) {
        ...
        case 3:
          ...
          if (d === e) fe(), (b = ke(a, b, c));
          else {
            if ((e = b.stateNode.hydrate))
              Sa ? ((Yd = tb(b.stateNode.containerInfo)), (Xd = b), (e = Zd = !0)) : (e = !1);
            if (e)
              for (c = kd(b, null, d, c), b.child = c; c; ) (c.effectTag = (c.effectTag & -3) | 1024), (c = c.sibling);
            else P(a, b, d, c), fe();
            b = b.child;
          }
          return b;
        ...
        case 4:
          return (
            pd(b, b.stateNode.containerInfo),
            (d = b.pendingProps),
            null === a ? (b.child = jd(b, null, d, c)) : P(a, b, d, c),
            b.child
          );
        ...
        case 10:
          a: {
            ...
            if (null !== g) {
              ...
              f = mc(l, f)
                ? 0
                : ('function' === typeof d._calculateChangedBits ? d._calculateChangedBits(l, f) : 1073741823) | 0;
        ...
        case 9:
          return (
            ...
            (d = f.children),
            xc(b, c),
            (e = zc(e, f.unstable_observedBits)),
            (d = d(e)),
            (b.effectTag |= 1),
            P(a, b, d, c),
            b.child
...
const version = '1.0.4';
const name = 'react-phaser-bindings';
...
var Zone = TYPES.ZONE; // export const Graphics = TYPES.GRAPHICS;
...
var lodash = createCommonjsModule(function(module, exports) {
  (function() {
     ...
     */ var runInContext = function runInContext(context) {
      ...
      /** Built-in value references. */ var Buffer = moduleExports ? context.Buffer : undefined$1,
...
var insertBefore = function insertBefore(arr, b, a) {
...
var SCENE_HOOKS = ['init', 'preload', 'create', 'update'];
var performedProps = {
...
var Scene$1 =
  ...
  (function(_Phaser$Scene) {
    ...
    function Scene(props) {
      ...
      _this[HOOKS] = hooks;
      _this[PROPS] = props;
      window.sc = _assertThisInitialized(_this);
    ...
    _createClass(GameObject, [
      {
        ...
        value: function register(scene) {
          console.warn('Register method of '.concat(this, ' should be overwritten'));
        }
      },
      {
        key: 'add',
      ...
      {
        key: 'insertBefore',
        value: function insertBefore$1(child, beforeChild) {
          this.add(child);
      ...
      },
      {
        ...
        value: function registerChildren() {
          ...
          try {
            for (
              var _iterator = pool[Symbol.iterator](), _step;
          ...
          try {
            for (
              var _iterator2 = scenePool[Symbol.iterator](), _step2;
      ...
      },
      {
        ...
        value: function update(newProps, oldProps) {
          var props = _objectSpread(
            {},
            lodash_1(defaultProps, this.allowedProps),
            {},
            this.defaultProps,
            {},
            lodash_1(newProps, this.allowedProps),
            {},
            lodash_1(newProps, eventNames)
          );
...
var allowedProps$1 = ['x', 'y', 'z', 'width', 'height', 'alpha', 'angle', 'scale', 'tint', 'visible'];
...
var interactive = function interactive(inst, _ref10) {
  var interactive = _ref10.interactive;
...
var textChildren = function textChildren(inst, _ref11) {
...
var allowedProps$2 = [
  ...
  'visible',
  'origin',
  'interactive', // 'animations', TODO or leave writeonceonly
  'startFrame',
  'play'
];
          ...
          if (animations && Array.isArray(animations)) {
            animations.forEach(function(config) {
              ...
              if (key) {
                ...
                if (anim) {
                  console.warn(
                    'Animation "'.concat(key, '" is already registered in this Scene "').concat(sceneKey, '"')
                  );
                  return;
                }

                anim = new Phaser.Animations.Animation(anims, key, _this.prepareAnimationConfig(config));
...
var allowedProps$4 = ['play', 'pause', 'marker', 'mute', 'volume', 'rate', 'detune', 'seek', 'loop', 'delay'];
...
var _Phaser$GameObjects = Phaser.GameObjects,
  Components = _Phaser$GameObjects.Components,
  GameObject$1 = _Phaser$GameObjects.GameObject;
var getTintAppendFloatAlpha = Phaser.Renderer.WebGL.Utils.getTintAppendFloatAlpha;
var videoTypes = ['webm', 'ogg', 'mp4', 'h264', 'vp9', 'hls'];
var elementEvents = ['canplay', 'canplaythrough', 'loadstart', 'playing', 'stalled', 'ended', 'error', 'pause'];
...
var VideoGameObject =
  /*#__PURE__*/
  (function(_GameObject) {
    _inherits(VideoGameObject, _GameObject);

    function VideoGameObject(scene, config) {
      var _this;

      _classCallCheck(this, VideoGameObject);
      ...
      var src = config.src,
        ...
        width = _config$width === void 0 ? 1 : _config$width,
        _config$height = config.height,
        height = _config$height === void 0 ? 1 : _config$height;
      _this = _possibleConstructorReturn(this, _getPrototypeOf(VideoGameObject).call(this, scene, 'Video'));
      _this.renderer = scene.sys.game.renderer;
      _this.resolution = scene.sys.game.config.resolution;
      _this.canvas = CanvasPool.create(
        _assertThisInitialized(_this),
        _this.resolution * width,
        _this.resolution * height
      );
      ...
      _this.createVideoElement(config);
    ...
    _createClass(VideoGameObject, [
      ...
      {
        key: 'renderWebGL',
        value: function renderWebGL(renderer, src, interpolationPercentage, camera, parentMatrix) {
      ...
      {
        key: 'renderCanvas',
        value: function renderCanvas(renderer, src, interpolationPercentage, camera, parentMatrix) {
          if (this.readyState > 0) {
      ...
      {
        key: 'getPixel',
        value: function getPixel(x, y, out) {
          if (out === undefined) {
            out = new Color();
          }
      ...
      {
        key: 'updateTexture',
        value: function updateTexture(callback, scope) {
          if (callback) {
            if (scope) {
      ...
      },
      {
        ...
        value: function createVideoElement() {
          ...
          var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : emptyObject_1;
          ...
          try {
            var _loop = function _loop() {
              ...
              element.addEventListener(key, function() {
                return _this2.emit(key, _this2);
              });
            };

            for (
              var _iterator = elementEvents[Symbol.iterator](), _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
              _iteratorNormalCompletion = true
            ) {
              _loop();
          ...
          var _config$playbackTimeC = config.playbackTimeChangeEventEnable,
            playbackTimeChangeEventEnable = _config$playbackTimeC === void 0 ? true : _config$playbackTimeC;
          this.video = element;
      ...
      },
      {
        ...
        value: function preUpdate(time, delta) {
          ...
          if (_get(_getPrototypeOf(VideoGameObject.prototype), 'preUpdate', this)) {
            _get(_getPrototypeOf(VideoGameObject.prototype), 'preUpdate', this).call(this, time, delta);
          }
        }
      },
      {
        ...
        value: function load(src) {
          ...
          var supportedVideoTypes = this.scene.sys.game.device.video;
          ...
          if (typeof src === 'object') {
            ...
            try {
              for (
                var _iterator2 = videoTypes[Symbol.iterator](), _step2;
                !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
                _iteratorNormalCompletion2 = true
              ) {
                var ext = _step2.value;

                if (supportedVideoTypes[''.concat(ext, 'Video')] && src[ext]) {
                  src = src[ext];
                }
              }
            } catch (err) {
    ...
    _createClass(Video, [
      {
        ...
        value: function register(scene) {
          this.scene = scene;
          this.instance = new VideoGameObject(scene, this.props);
          this.registered = true;
...
var allowedProps$8 = ['x', 'y', 'width', 'height', 'interactive', 'origin'];
...
Object.assign(Zone$1.prototype, {
  name: '',
  type: TYPES.ZONE,
  performedProps: performedProps$9,
  allowedProps: allowedProps$8
});

/* eslint-disable no-unused-vars */

var PhaserRenderer = reactReconciler({
  appendInitialChild: function appendInitialChild(parent, child) {
    if (parent instanceof Scene$1) {
  ...
  createInstance: function createInstance(type, props, scope) {
    switch (type) {
      case TYPES.SCENE:
        return new Scene$1(props);

      case TYPES.CONTAINER:
        return new Container$1(props);

      case TYPES.IMAGE:
        return new Image$1(props);

      case TYPES.SPRITE:
        return new Sprite$1(props);

      case TYPES.TEXT:
        return new Text$1(props);

      case TYPES.BITMAPTEXT:
        return new BitmapText$1(props);

      case TYPES.AUDIO:
        return new Audio$1(props);

      case TYPES.VIDEO:
        return new Video$1(props);

      case TYPES.ZONE:
        return new Zone$1(props);

      default:
        return invariant_1('React-Phaser-Bindings: Can not insert node before itself');
    }
  },
  ...
  noTimeout: -1,
  now: scheduler_1,
  scheduleDeferredCallback: scheduler_2,
  cancelDeferredCallback: scheduler_3,
  ...
  commitUpdate: function commitUpdate(instance, updatePayload, type, oldProps, newProps, scope) {
    switch (type) {
      case TYPES.SCENE:
...
function VideoCanvasCreator(config, addToScene) {
  ...
  var gameObject = new VideoGameObject(this.scene, 0, 0, width, height, config);
  BuildGameObject(this.scene, gameObject, config);
  return gameObject;
}

function VideoCanvasFactory(config) {
  var gameObject = new VideoGameObject(this.scene, config);
...
var VideoPlugin =
  ...
  (function(_Phaser$Plugins$BaseP) {
    _inherits(VideoPlugin, _Phaser$Plugins$BaseP);

    function VideoPlugin(pluginManager) {
      var _this;

      _classCallCheck(this, VideoPlugin);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(VideoPlugin).call(this, pluginManager));
      pluginManager.registerGameObject('Video', VideoCanvasFactory, VideoCanvasCreator);
      Phaser.GameObjects.Video = VideoGameObject;
      return _this;
    }
