...
const version="1.3.1";const name="react-phaser-bindings";
...
var SCENE_HOOKS = ['onInit', 'onPreload', 'onCreate', 'onBeforeCreate', 'onUpdate'];
var performedProps = {
...
function (_Phaser$Scene) {
  ...
  function Scene(props) {
    ...
    var sceneProps = lodash_2(props, SCENE_HOOKS, 'assets', 'children');
    sceneProps.key = props.name;
    var hooks = lodash_1(props, SCENE_HOOKS);
    ...
    _this[ASSETS] = props.assets;
    _this[HOOKS] = lodash_1(hooks, SCENE_HOOKS);
    _this[PROPS] = props;
    return _this;
  }
  ...
  _createClass(Scene, [{
    ...
    key: "init",
    value: function init() {
      var onInit = this[HOOKS].onInit;

      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      onInit && onInit.call.apply(onInit, [this, this].concat(args));
    }
  }, {
    key: "preload",
    value: function preload() {
      ...
      var onPreload = this[HOOKS].onPreload;
      ...
      onPreload && onPreload.call.apply(onPreload, [this, this].concat(args));
    }
  }, {
    key: "create",
    value: function create() {
      ...
      onCreate && onCreate.call.apply(onCreate, [this, this].concat(args));
    }
  }, {
    key: "update",
    value: function update() {
      var onUpdate = this[HOOKS].onUpdate;

      for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
        args[_key4] = arguments[_key4];
      }

      onUpdate && onUpdate.call.apply(onUpdate, [this, this].concat(args));
    }
  }]);
...
function () {
  ...
  _createClass(GameObject, [{
    ...
    value: function removeTransitionTween(key) {
      var onTransitionComplete = this.props.onTransitionComplete;
      ...
      if (tween.isPlaying()) {
        tween.stop();
        onTransitionComplete && setTimeout(function () {
          return onTransitionComplete(key);
        }, 2);
      }
...
var transitionProps$2 = ['x', 'y', 'alpha', 'angle', 'scale', 'tint'];
...
var updateTween = function updateTween(inst, value, object) {
  object.resetTween();
};
...
var allowedProps$8 = ['from', 'to', 'duration', 'delay', 'play'];
var CounterMixin = {
  defaultProps: {
    locale: undefined,
    pattern: undefined,
  ...
  resetTween: function resetTween() {
  ...
  preRegister: function preRegister() {
    if (this.registered) return;
    this.resetTween();
  },
...
var allowedProps$9 = [].concat(_toConsumableArray(allowedProps$6), _toConsumableArray(allowedProps$8)).filter(function (key) {
  return key !== 'children';
});
...
function (_Text) {
  ...
  function CounterText() {
    ...
    _this.handleOnUpdate = function (tween, _ref) {
      ...
      var text = _this.formatNumber(value);
...
var allowedProps$a = [].concat(_toConsumableArray(allowedProps$7), _toConsumableArray(allowedProps$8)).filter(function (key) {
  return key !== 'children';
});
...
var allowedProps$b = ['x', 'y', 'z', 'radius', 'fillColor', 'alpha', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'origin', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$c = ['x', 'y', 'z', 'width', 'height', 'fillColor', 'alpha', 'origin', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$d = ['x', 'y', 'z', 'x1', 'y1', 'x2', 'y2', 'x3', 'y3', 'fillColor', 'alpha', 'origin', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$e = ['x', 'y', 'z', 'width', 'height', 'fillColor', 'alpha', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'origin', 'visible', 'interactive', 'stroke'];
...
var allowedProps$f = ['x', 'y', 'z', 'points', 'fillColor', 'alpha', 'angle', 'origin', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$g = ['x', 'y', 'z', 'points', 'innerRadius', 'outerRadius', 'fillColor', 'alpha', 'origin', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$h = ['x', 'y', 'width', 'height', 'interactive', 'origin'];
...
var allowedProps$i = ['texture', 'frame', 'pause', 'start'];
...
var allowedProps$k = ['x', 'y', 'frame', 'data'];
...
var allowedProps$l = ['x', 'y', 'width', 'height', 'placeholder', 'value', 'readonly', 'style', 'tooltip'];
var eventMap$2 = {
  onInput: 'input',
  onChange: 'change',
  onDbClick: 'dblclick',
