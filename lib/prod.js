...
var allowedProps$c = ['texture', 'frame', 'x', 'y', 'z', 'width', 'height', 'origin', 'alpha', 'angle', 'scale', 'tint', 'visible', 'interactive', 'mask'];
...
Object.assign(Image$2.prototype, {
  type: TYPES.IMAGE,
...
var allowedProps$d = ['x', 'y', 'width', 'height', 'interactive', 'origin'];
...
var allowedProps$e = ['texture', 'frame', 'pause', 'start'];
...
var allowedProps$g = ['x', 'y', 'frame', 'data'];
...
var allowedProps$h = ['x', 'y', 'width', 'height', 'placeholder', 'value', 'readonly', 'style', 'tooltip'];
var eventMap$1 = {
  onInput: 'input',
  onChange: 'change',
  onDbClick: 'dblclick',
