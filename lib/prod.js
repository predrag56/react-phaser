...
const version="0.2.1";const name="react-phaser-bindings";
...
function (_GameObject) {
  ...
  _createClass(VideoGameObject, [{
    ...
    value: function createVideoElement() {
      ...
      var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : emptyObject;
...
Phaser.Class.mixin(VideoGameObject, [Components.Alpha, Components.BlendMode, Components.ComputedSize, Components.Crop, Components.Depth, Components.Flip, Components.GetBounds, Components.Mask, Components.Origin, Components.Pipeline, Components.ScrollFactor, Components.Tint, Components.Transform, Components.Visible]);
...
var allowedProps$7 = ['x', 'y', 'key', 'children', 'fontSize', 'font', 'interactive', 'width', 'height', 'align', 'origin'];
...
var performedProps$9 = {
  interactive: function interactive(inst, _ref) {
    var _interactive = _ref.interactive;
...
var allowedProps$8 = ['x', 'y', 'width', 'height', 'interactive'];
...
function (_Component) {
  ...
  _createClass(GameContext, [{
    ...
    value: function componentDidMount() {
      ...
      var game = new Phaser.Game(_objectSpread$2({
        type: Phaser.AUTO
      }, config, {
        autoStart: false,
        parent: this[tagRef],
