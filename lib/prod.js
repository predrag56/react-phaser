...
var Zone = TYPES.ZONE;
var Particles = TYPES.PARTICLES; // export const Graphics = TYPES.GRAPHICS;
...
function () {
  ...
  _createClass(GameObject, [{
    ...
    value: function update(newProps, oldProps) {
      var props = _objectSpread({}, lodash_1(defaultProps, this.allowedProps), {}, this.defaultProps, {}, lodash_1(newProps, this.allowedProps), {}, lodash_1(newProps, eventNames));
...
function (_Particle) {
  ...
  function AnimatedParticle(scene, animationName, emitter) {
    ...
    _this.i = 0;
    _this.scene = scene;
    _this.anims = new Phaser.GameObjects.Components.Animation(_assertThisInitialized(_this));
...
function (_Component) {
  ...
  _createClass(GameContext, [{
    ...
    value: function componentDidMount() {
      ...
      var game = new Phaser$1.Game(_objectSpread$4({
        type: Phaser$1.AUTO
      }, config, {
        autoStart: false,
        parent: this[tagRef],
