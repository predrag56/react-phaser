...
var allowedProps$9 = ['x', 'y', 'z', 'width', 'height', 'color', 'alpha', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
var allowedProps$a = ['texture', 'frame', 'x', 'y', 'z', 'width', 'height', 'origin', 'alpha', 'angle', 'scale', 'tint', 'visible', 'interactive', 'mask'];
...
var allowedProps$b = ['x', 'y', 'z', 'width', 'height', 'color', 'alpha', 'angle', 'strokeWidth', 'strokeColor', 'strokeAlpha', 'smoothness', 'scale', 'visible', 'interactive', 'stroke'];
...
Object.assign(Image$3.prototype, {
  type: TYPES.IMAGE,
